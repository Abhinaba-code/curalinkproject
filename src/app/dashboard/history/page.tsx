...
const getActivityDescription = (item: HistoryItem) => {
    switch (item.type) {
        case 'trial_search':
            return `Searched for trials: "${item.query}"`;
        case 'publication_search':
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            A log of your recent searches and activities.
          </p>
        </div>
        {history.length > 0 && (
            <AlertDialog>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This action cannot be undone. This will permanently delete all of your activity history.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
      ...
      {history.length === 0 ? (
        <Card className="flex flex-col items-center justify-center h-80 text-center text-muted-foreground border-dashed">
          ...
          <CardContent>
            ...
            <p className="text-sm">
              Your recent searches and activities will appear here.
            </p>
          </CardContent>
        </Card>
      ) : (
