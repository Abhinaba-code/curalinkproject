        ...
        return (
            <div className="flex h-64 items-center justify-center rounded-lg border-2 border-dashed">
                <div className="text-center text-muted-foreground">
                    ...
                    <p>Please enter a search term in the header to begin.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-8">
            {trials.length > 0 && (
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2"><FlaskConical /> Clinical Trials</CardTitle>
                        <CardDescription>Top clinical trial results matching your search.</CardDescription>
                    </CardHeader>
            ...
            {publications.length > 0 && (
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2"><FileText /> Publications</CardTitle>
                        <CardDescription>Top publication results matching your search.</CardDescription>
                    </CardHeader>
            ...
            {experts.length > 0 && (
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2"><Users /> Health Experts</CardTitle>
                        <CardDescription>Top health expert results matching your search.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">
                    Aggregated results from across the CuraLink platform.
                </p>
            </div>
